...
const CONTROL_ROLE = "platform-operator";
const CONTROL_ROLES: readonly string[] = [CONTROL_ROLE];
...
const AUTHORED: readonly Authored[] = [
  {
    ...
    roles: CONTROL_ROLES, effects: READ, idempotency: "natural",
  ...
  },
  {
    ...
    roles: [CONTROL_ROLE], effects: WRITE_EXTERNAL, idempotency: "natural",
  ...
  },
  {
    ...
    roles: [CONTROL_ROLE], effects: WRITE_EXTERNAL, idempotency: "natural", acknowledgement: true,
  ...
  },
  {
    ...
    roles: [CONTROL_ROLE], effects: WRITE, idempotency: "natural",
  ...
  },
  {
    ...
    roles: CONTROL_ROLES, effects: READ_EXTERNAL, idempotency: "natural",
    input: { properties: { slug }, required: ["slug"] },
  ...
  },
  {
    ...
    description: "Reads safe metadata for one outstanding tenant invitation.", roles: CONTROL_ROLES, effects: READ_EXTERNAL, idempotency: "natural",
  ...
  },
  {
    ...
    description: "Invites one tenant member and records the selected allowlisted role.", roles: [CONTROL_ROLE], effects: WRITE_EXTERNAL, idempotency: "natural",
  ...
  },
  {
    ...
    roles: CONTROL_ROLES, effects: WRITE_EXTERNAL, idempotency: "natural", acknowledgement: true,
  ...
  },
  {
    ...
    roles: CONTROL_ROLES, effects: WRITE_EXTERNAL, idempotency: "none", acknowledgement: true,
    input: { properties: { slug, invitationId: { type: "string", pattern: "^[a-zA-Z0-9_-]{1,128}$" } }, required: ["slug", "invitationId"] },
  ...
  },
  {
    ...
    description: "Lists members of one tenant organization with safe identity metadata.", roles: CONTROL_ROLES, effects: READ_EXTERNAL, idempotency: "natural",
  ...
  },
  {
    ...
    description: "Reads one verified tenant member.", roles: CONTROL_ROLES, effects: READ_EXTERNAL, idempotency: "natural",
  ...
  ...(["assign", "remove"] as const).map((mode): Authored => ({
    ...
    description: `${mode} allowlisted roles for one verified tenant member.`, roles: [CONTROL_ROLE], effects: WRITE_EXTERNAL, idempotency: "natural", acknowledgement: true,
  ...
  },
  {
    ...
    description: "Sends the fixed passwordless WebAuthn registration action to one verified member.", roles: [CONTROL_ROLE], effects: WRITE_EXTERNAL, idempotency: "none", acknowledgement: true,
  ...
  },
  {
    ...
    description: "Lists safe credential metadata for one verified member.", roles: CONTROL_ROLES, effects: READ_EXTERNAL, idempotency: "natural",
  ...
  },
  {
    ...
    description: "Reads safe metadata for one credential.", roles: CONTROL_ROLES, effects: READ_EXTERNAL, idempotency: "natural",
  ...
  },
  {
    ...
    description: "Revokes one credential with last-credential recovery protection.", roles: [CONTROL_ROLE], effects: WRITE_EXTERNAL, idempotency: "natural", acknowledgement: true,
  ...
  },
  {
    ...
    roles: [CONTROL_ROLE], effects: READ, idempotency: "natural",
  ...
  },
  {
    ...
    roles: [CONTROL_ROLE], effects: WRITE, idempotency: "none", acknowledgement: true,
  ...
  },
  {
    ...
    roles: [CONTROL_ROLE], effects: WRITE, idempotency: "natural", acknowledgement: true,
