...
import { readAppRolePassword } from "./migrations/app-role.js";
import { readWorkerRolePassword } from "./migrations/worker-role.js";
...
const adminUrl = process.env.OPENSHAPEFORGE_ADMIN_DATABASE_URL ?? readMigrateDatabaseUrl();
