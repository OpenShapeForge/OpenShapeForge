...
const parentTable: GeneratedCrudTable = { ...sourceDefinition, columns: ownColumns, source: { ...sourceDefinition?.source, computedFields: [], graphql: { ...sourceDefinition?.source?.graphql!, relationships: [inverse, association] } } };
const childTable: GeneratedCrudTable = { ...targetDefinition, columns: [...ownColumns, { name: "parent_id", sourceField: "parent", type: "uuid", primaryKey: false, required: false, generated: null }, { name: "parent_id_position", type: "integer", primaryKey: false, required: true, generated: null }], source: { ...targetDefinition?.source, computedFields: [], graphql: { ...targetDefinition?.source?.graphql!, relationships: [belongsTo] } } };
