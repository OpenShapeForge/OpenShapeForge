...
describe("rich generated REST OpenAPI", () => {
  it("renders host-authored developer onboarding without losing generator provenance", () => {
    const rendered = JSON.parse(renderOpenApiSpec(manifest, "fixture", {
      entities: [{ contract }],
      documentation: {
        title: "Example Product API",
        version: "2026-09",
        description: "Authenticate first, then create a relation.",
        externalDocs: {
    ...
    expect(rendered.info).toEqual({
      title: "Example Product API",
      version: "2026-09",
      description:
        "Authenticate first, then create a relation.\n\n---\n\n" +
