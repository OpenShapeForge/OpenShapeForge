...
const GENERIC_DEVELOPER_ONBOARDING = [
  ...
  "   protected operation, the caller's roles still decide which documented entities",
  "   and fields may be read or written, so a contract-valid request can receive",
  "   `401` or `403`.",
